...
const SongData = ({ parent }) => {
  ...
  return (
    <section className="flex flex-col items-center justify-center align-bottom">
      {(song && (
        <div className="flex flex-col items-center justify-center text-center align-bottom">
          <motion.div className="">
            <motion.div className="flex items-end justify-center text-center align-bottom">
              <motion.div
                className={clsx(
                  "flex static max-w-[300px] max-h-[300px] data-image-container group",
                  sticky && "fixed top-[56px] md:top-0 md:pt-2"
                )}
                onClick={() => {
                  getSong(null);
                }}
          ...
          <motion.div
            className={clsx(
              "flex flex-col items-center justify-center text-center align-middle data-info col-md-8 text-md-start"
            )}
            style={{
              height: scrollHeight
            }}
